...
//var TEXT_FILE_PATH = '/opt/usr/home/owner/apps_rw/org.tizen.smart-surveillance-camera/shared/data/lhy.text';
...
if (ENABLE_WEBSOCKET) {
  ...
  function Listener(ws) {
    ...
    var timeout = setInterval(function() {
      ...
      // textdata =  fs.readFileSync(TEXT_FILE_PATH, 'utf8');
